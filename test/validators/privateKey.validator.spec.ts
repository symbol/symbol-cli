...
describe('private key validator', () => {
    ...
    it(' private key should be a 64 characters hexadecimal string', () => {

        const privateKey  = '770DE78BF2AD0531BB7589C8839AB43F5764064785AB1E28160AEF7D3A4C2D4B' ;
        expect(new PrivateKeyValidator().validate(privateKey,
            { name: 'privateKey', source: privateKey })).to.be.equal(undefined);
    });
