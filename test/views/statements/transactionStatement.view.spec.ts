...
describe('Transaction Statement Views', () => {
 it('Renders transaction statements', () => {
  ...
  expect(statementsView[0][7]).deep.equal({ 'Target account': 'NAHTHI-O4LNIL-5UUCJD-S4JM5G-CCIHXP-SDLDSV-RI53' })
  ...
  expect(statementsView[0][13]).deep.equal({ Sender: 'NAHTHI-O4LNIL-5UUCJD-S4JM5G-CCIHXP-SDLDSV-RI53' })
  expect(statementsView[0][14]).deep.equal({ Recipient: 'NCKQSD-7ORC23-AYGKZB-DHS2TL-3UVYAB-6EWQXL-EDI6' })
