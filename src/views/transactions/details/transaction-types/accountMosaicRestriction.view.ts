...
export class AccountMosaicRestrictionView {
    ...
    private render(): CellRecord {
        return {
            'Account restriction flag': MosaicRestrictionFlag[this.tx.restrictionFlags],
    ...
    private getRestrictions(): CellRecord {
        ...
        return {
            ...this.tx.restrictionAdditions.reduce(
                (acc, mosaic, index) => ({
                    ...acc,
                    ...this.renderRestriction(mosaic, index, numberOfAdditions, 'Addition'),
                }),
                {},
            ),
            ...this.tx.restrictionDeletions.reduce(
                (acc, mosaic, index) => ({
                    ...acc,
                    ...this.renderRestriction(mosaic, index, numberOfDeletions, 'Deletion'),
                }),
                {},
            ),
        };
