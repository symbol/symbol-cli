...
export class NetworkCurrency {
    ...
    public static createFromFirstBlockTransactions(transactions: Transaction[]): NetworkCurrency {
        ...
        const mosaicDefinitionTx = transactions.find((tx) => tx instanceof MosaicDefinitionTransaction) as MosaicDefinitionTransaction;

        if (mosaicDefinitionTx === undefined) {
            throw new Error('mosaic definition transaction not found');
        }
