...
:warning: 0.22.4 breaks compatibility with the ``profiles`` (Testnet change) saved using previous versions of the software
Before installing ``symbol-cli@0.22.4``, backup and delete the file ``~ \.symbolrc.json``
